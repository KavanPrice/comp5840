...
write_file = open('dialect_data6.arff', 'w', encoding='utf-8', newline='')
...
for file in os.listdir(RESOURCE_PATH):
    ...
    if file == 'spanishCL.txt':
        spanish_class = 'chile'
    elif file == 'spanishCO.txt':
        spanish_class = 'colombia'
    elif file == 'spanishCU.txt':
        spanish_class = 'cuba'
    elif file == 'spanishMX.txt':
        spanish_class = 'mexico'
    elif file == 'spanishPE.txt':
        spanish_class = 'peru'
    else:
